...
export class SocialHistoryComponent implements OnInit {
  ...
  getSocialHistory() {
    this.socialHistoryService.getSocialHistoryByPatientId(this.patientId).subscribe(data => {
      ...
      console.log("socialHistory", this.socialHistory);
      ...
      this.frequencyValueAlcohol = this.Alcohol[0].FrequencyValue;
      this.frequencyValueExcercise = this.Excercise[0].FrequencyValue;
      this.frequencyUnitExcercise = this.Excercise[0].FrequencyUnit;
      this.frequencyUnitAlcohol = this.Alcohol[0].FrequencyUnit;
      var today = new Date();
      ...
      console.log("Excercise", this.Excercise);
